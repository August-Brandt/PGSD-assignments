...
// *Made an example of the let binding from the book
let bbla = Let("x1", Prim("+", CstI 5, CstI 7), Let("x2", Prim("*", Var "x1", CstI 2), Prim("+", Var "x1", Var "x2")))
...
let run e = eval e [];;
// *Also eval "bbla"
let res = List.map run [e1;e2;e3;e4;e5;e7; bbla]  (* e6 has free variables *)
...
let pp = List.map closed1 [e1;e2;e3;e4;e5;e6;e7;e8;e9;e10]
...
let l = List.map closed2 [e1;e2;e3;e4;e5;e6;e7;e8;e9;e10]
...
// *Made a test an example here 
let tbla = tcomp bbla [];;
let tblaeval = teval tbla [];;
