...
let ex21 = fromString "let x = { } in x end";;

let ex22 = fromString "let x = {field1 = 32} in x.field1 end";;

let ex23 = fromString "let x = {field1 = 32; field2 = 33} in x end";;

let ex24 = fromString "let x = {field1 = 32; field2 = 33} in x.field1 end";;

let ex25 = fromString "let x = {field1 = 32; field2 = 33} in x.field1+x.field2 end";;